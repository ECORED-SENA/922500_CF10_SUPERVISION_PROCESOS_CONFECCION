    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo.color-acento-contenido
          h2 Métodos de trabajo y estudio de tiempos
        p.mb-4 Comprender los métodos existentes en el estudio de trabajo para una correcta estandarización de procesos y operaciones.
